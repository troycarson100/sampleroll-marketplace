...
export default async function SoundsPage({
  ...
  const center = (
    <>
      ...
      <div className="px-3 pb-16 pt-3 sm:px-5 lg:px-6 lg:pb-20">
        <div className="rounded-2xl border border-stitch-outline-variant/10 bg-stitch-surface-container-low/40 px-4 py-8 shadow-inner shadow-black/20 sm:px-6 lg:px-8">
